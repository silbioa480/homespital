...
//
//            // 빌링키 발급 요청
//            JSONObject billingKey = paymentService.getBillingKey(authToken, cardData, user);
...
//            String authToken = params.get("authToken");
            ...
            JSONObject at = paymentService.getAuthToken();
            System.out.println(at.getString("access_token"));
            r = paymentService.pay(at.getString("access_token"), customer_uid, merchant_uid, amount, name);
