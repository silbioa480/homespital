...
<script>
    ...
    if ((${diagnosis.is_diagnosis_upload}) == 0) {
        ...
        receipt = "<button type='button' data-bs-toggle='modal' data-bs-target='#staticBackdrop" + ${diagnosis.diagnosis_number} +" 'id ='receiptUpload" + ${diagnosis.diagnosis_number} +"' class='btn btn-info btn-sm h-75'>영수증업로드</button><br>" +
            ...
            '<input type="file" accept=".gif, .jpg, .png, .jpeg" name="receiptFile">사진선택</input></div><div class="modal-footer"><button type="button" class="btn btn-secondary"  data-bs-dismiss="modal">닫기</button><button type="submit" class="btn btn-primary upload-btn' + (${diagnosis.diagnosis_number}) + '">확인</button></div></form></div></div></div>'
    ...
    if ((${diagnosis.is_prescription_upload}) == 0) {
        ...
        prescription = "<button type='button' data-bs-toggle='modal' data-bs-target='#staticBackdrop2_" + (${diagnosis.diagnosis_number}) + " 'id ='prescriptionUpload" + (${diagnosis.diagnosis_number}) + "' class='btn btn-info btn-sm h-75'>처방전업로드</button><br>" +
            ...
            "<input type='hidden' name='diagnosis_number' value='" + (${diagnosis.diagnosis_number}) + "'>" +
            '<input type="file" accept=".gif, .jpg, .png, .jpeg" name="prescriptionFile">사진선택</input></div><div class="modal-footer"><button type="button" class="btn btn-secondary"  data-bs-dismiss="modal">닫기</button><button type="submit" class="btn btn-primary upload-btn' + (${diagnosis.diagnosis_number}) + '">확인</button></div></form></div></div></div>';
