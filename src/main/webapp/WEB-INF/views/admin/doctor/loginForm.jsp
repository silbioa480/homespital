...
<!-- Header -->
<header id="header">
    <h1 style="margin-left: 60px; font-weight: bolder; margin-bottom: 30px">의사 로그인</h1>
</header>
...
<div class="login_box">
    <div class="content">
        <form id="signup-form" method="post" action="/doctor/docLogin">
...
<!-- Scripts -->
<script src="/resources/js/login/docLogin.js"></script>
