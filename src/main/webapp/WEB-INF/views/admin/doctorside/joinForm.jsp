...
<br>
                    ...
                    <table onload="Init();">
                        ...
                        <tr>
                            <td><select id="allowList" size="10" ondblclick="Add(this)"></select></td>
                            <td>&nbsp;</td>
                            <td><select id="denyList" size="10" ondblclick="Remove(this)"></select></td>
                        </tr>
                    </table>
            ...
            <section id="three">
                <div class="container">
                    <div style="font-size: 25px">추가 정보 입력<strong style="color: #807d7d">(선택)</strong></div>
