...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/css/after.css" />
    ...
    <div data-scroll class="page page--layout-2">
        ...
        <div class="meta">
            ...
            <div class="meta__demos">
                ...
                <p class="meta__demo" style="font-weight: bold;">이훈</p>
                <p class="meta__demo" style="font-weight: bold;">원종호</p>
        ...
        <div class="content content--full content--alternate">
            <div class="content__item content__item--wide" id="one">
                ...
                <p style="margin-left: 200px; font-weight: 550;">좋은 팀원들을 만나 이번 프로젝트를 끝낼 수 있었습니다. 감사합니다.</p>
            </div>
            ...
            <div class="content__item content__item--wide" id="two">
                ...
                <p class="content__item-description" style="font-weight: 550;">저희 정말 고생했습니다. 조금 늦게 시작했기 때문에 누구보다 열심히 했습니다.<br>
                    파이널 프로젝트를 통해서 비로소 팀워크가 뭔지 알게 되었고,<br>
                    무엇보다 저의 부족함을 티안나게 채워준 우리 7조 팀원분들과 묵묵히<br>
            ...
            <div class="lastImg">
                <img src="/resources/img/after/sub.jpg" class="lastImg" />
                <img src="/resources/img/after/sub1.png" class="sub" />
            </div>
            <div class="lastImg">
                <img src="/resources/img/after/real.jpg" class="lastImg" />
            </div>
            <div class="lastImg">
                <img src="/resources/img/after/ha.png" class="lastImg" />
            </div>
            <div class="lastImg">
                <img src="/resources/img/after/fourCut.png" class="lastImg" />
            </div>
            <div class="lastImg">
                <img src="/resources/img/after/one.png" class="lastImg" />
            </div>
            <div class="lastImg">
                <img src="/resources/img/after/sss.png" class="lastImg" />
            </div>
            <div class="lastImg">
                <img src="/resources/img/after/steve.png" class="lastImg" />
            </div>
            <div class="lastImg">
...
<script src="/resources/js/after1.js"></script>
<script src="/resources/js/after.js"></script>
</body>
</html>