...
<header id="header">
    <a href="/"><h1>Homespital</h1></a>
    <nav>
        <ul>
            <li><a href="loginForm">로그인</a></li>
            <li><a href="joinForm">회원가입</a></li>
            <li><a href="welcome">의교 관계자 로그인</a></li>
...
<%--인성--%>
<%--<header>--%>
<%--    <img class="logo" src="/resources/img/QR.png" alt="logo" style="width: 20px; height: 20px">--%>
<%--    <nav>--%>
<%--        <ul class="nav_links">--%>
<%--            <li><a href="#">로그인</a></li>--%>
<%--            <li><a href="#">회원가입</a></li>--%>
...
<%--        </ul>--%>
<%--    </nav>--%>
<%--    <a class="btn" href="/"><button>의료 관계자</button></a>--%>
<%--</header>--%>
