...
예) 감기 기운이 있고, 머리가 아파요! 증상을 구체적으로 적어주세요!" style="width: 100%; min-height: 200px;"></textarea>
        ...
        <div class="card p-3">
            ...
            <div class="card p-3">
                ...
                <div>
                    카드 정보
                    <input type="text" id="default_card" value="${cardInfo.card_nickname}" disabled="disabled"/>
    ...
    function submitNewCardId() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                card = data.card_nickname + " (" + data.card_number + ")";
                $('#default_card').val(card);
                $('#billing_key').val(data.card_number);
