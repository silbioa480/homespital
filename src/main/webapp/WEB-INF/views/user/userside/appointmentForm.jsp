        ...
        <section class="card p-3" id="one">
            ...
            <div class="card p-3">
                <div class="row g-0">
                    ...
                    <div class="card p-3">
                        <h5><strong>시간 예약 주의사항</strong></h5>
...
예) 감기 기운이 있고, 머리가 아파요! 증상을 구체적으로 적어주세요!" style="width: 100%; min-height: 200px;"></textarea>
        ...
        <section class="card p-3" id="three">
            ...
            <div id="naebang">
                <div class="p-4">
                    ...
                    <p class="appointmentNotice">
                        * 조제의약품 수령 방법을 약국 내방으로 선택 시, 조제가 완료 되면 휴대폰으로 결제와 함께 알림 문자 메세지가 전송 됩니다.<br>
                        * 약국 내방 시 [제조완료] 시간으로 부터 1시간동안 약이 보관되며, 이후에는 관련 의료법에 따라 약제는 폐기되며, 제조 완료 시간에 맞추어 약국 내방을 권유
                        드립니다.<br>
                        * 혹시라도 사정이 생겨 내방이 힘드시거나 기타 문의 사항이 있으시면 상기 약국 번호로 전화 주시기 바랍니다.
                    </p>
                    <hr>
        ...
        <section class="card p-3" id="four">
            ...
            <hr>
            <h5><strong>결제 주의사항</strong></h5>
            <p class="appointmentNotice">
                * 입력하신 결제 정보를 바탕으로 진료가 끝나면 진료비가 자동 결제 됩니다.<br>
                * 약 처방이 있는 경우에는 조제후 약제 비용이 자동으로 결제 됩니다.<br>
                * 진단에 따라 처방의 유무가 결정되기 때문에 진단 시/조제 시 결제가 두번 되는 부분 안내 드립니다.
            </p>
            <hr>
