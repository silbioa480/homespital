            ...
            <form id="form" style="margin-left: 100px" action="/modifyMember.do" method="post">
                ...
                <section id="three">
                    <div class="container">
                        ...
                        <button id="writeCard" class="btn" onclick="return false;">추가</button>
                        <%--                        모달 --%>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="input-control">
                                            ...
                                            <div style="display:flex">
                                                ...
                                                <input style="width: 23%; height:40px;" id="cardNumModal2"
                                                       type="password"
                                                       name="cardNumModal2" maxlength="4" minlength="4"/>
                                                <span style="line-height:40px;">-</span>
                                                <input style="width: 23%; height:40px;" id="cardNumModal3"
                                                       type="password"
                    ...
                    <div style="display:flex">
                        ...
                        <a class="btn" id="deleteMem" href="/delete" style="margin-right: 0px">탈퇴</a>
                    </div>
